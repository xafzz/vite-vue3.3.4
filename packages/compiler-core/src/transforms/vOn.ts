...
import { ElementTypes, NodeTypes, createCompoundExpression, createObjectProperty, createSimpleExpression } from "../ast"
...
export const transformOn = (
  ...
  const { loc, modifiers, arg } = dir as any
  ...
  // handler processing
  let exp: any | undefined = dir.exp as
    | any
    | undefined

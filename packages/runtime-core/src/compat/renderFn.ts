...
export function convertLegacyRenderFn(instance: any) {
  const Component = instance.type as any
  const render = Component.render as any | undefined
...
function convertLegacySlots(vnode: any): any {
...
export function defineLegacyVNodeProperties(vnode: any) {
  /* istanbul ignore if */
  if (
    isCompatEnabled(

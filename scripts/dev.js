...
// 获取打包目录
const buildDirs = ['vue','runtime-dom','runtime-core','compiler-core','compiler-dom','compiler-sfc','reactivity','shared']
...
watcher.on('change', path => { 
    ...
    if (path.indexOf('dist') === -1 && path.indexOf('packages') > -1) { 
        ...
        const dir = buildDirs.indexOf(changeDir[1]) > -1 ? [].concat(changeDir[1]) : ['vue']
        buildAll(dir)
    }
